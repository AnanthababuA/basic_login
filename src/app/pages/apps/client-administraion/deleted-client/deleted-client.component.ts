...
@Component({
  selector: 'app-deleted-client',
  templateUrl: './deleted-client.component.html',
  styleUrls: ['./deleted-client.component.scss'],
})
export class DeletedClientComponent {
  listOfRegClient: any;
  dtOptions: any;
  ...
  openDialogDeleteClientForm() {
    const dialogRef = this.dialog.open(DeleteClientFormComponent);
