...
@Component({
  selector: 'app-deleted-client-pop-up',
  templateUrl: './deleted-client-pop-up.component.html',
  styleUrls: ['./deleted-client-pop-up.component.scss'],
  standalone: true,
  imports: [DataTablesModule, CommonModule,  MatButtonModule,MatDialogModule ]
})
export class DeletedClientPopUpComponent {
