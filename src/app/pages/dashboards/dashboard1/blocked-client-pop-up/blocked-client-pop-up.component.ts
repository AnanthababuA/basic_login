...
@Component({
  selector: 'app-blocked-client-pop-up',
  templateUrl: './blocked-client-pop-up.component.html',
  styleUrls: ['./blocked-client-pop-up.component.scss'],
  standalone: true,
  imports: [DataTablesModule, CommonModule,  MatButtonModule,MatDialogModule ]
})
export class BlockedClientPopUpComponent {
  ...
  logReceivedAPI() {
    this.spinner.show();
    this.listOfDeletedClient = '';
    this.common.blockClientList().subscribe(
      (res: any) => {
